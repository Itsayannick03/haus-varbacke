...
{
    return(
    <div className="pt-25 pb-5 bg-gradient-to-b from-[#f8f5ef] to-white flex flex-col items-center">
            ...
            <div className="p-6 gap-3 w-120 rounded-md border border-1px border-gray-200 shadow-lg flex justify-center items-center flex-col">
                ...
                <button className="bg-[#eae6dc] border-2 border-[#cfc8b5] rounded-lg shadow-md w-full flex items-center justify-center">
                    <LuMapPin size={30} />
                </button>
